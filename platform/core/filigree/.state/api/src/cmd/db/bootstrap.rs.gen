...
pub struct BootstrapCommand {
    ...
    #[clap(long = "email", env = "GLANCE_BOOTSTRAP_ADMIN_EMAIL")]
    admin_email: Option<String>,

    /// The name for the admin user
    /// Defaults to "Admin"
    #[clap(long = "name", env = "GLANCE_BOOTSTRAP_ADMIN_NAME")]
    ...
    #[clap(
        long = "password-hash",
        env = "GLANCE_BOOTSTRAP_ADMIN_PASSWORD_HASH",
    ...
    #[clap(
        long = "password",
        env = "GLANCE_BOOTSTRAP_ADMIN_PASSWORD",
    ...
    #[clap(long = "org-name", env = "GLANCE_BOOTSTRAP_ORG_NAME")]
